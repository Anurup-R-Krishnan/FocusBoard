...
const SettingsDrawer: React.FC<SettingsDrawerProps> = ({ isOpen, onClose }) => {
  const SettingRow = ({ icon: Icon, label, value, type = 'toggle' }: any) => (
    <div className="flex items-center justify-between py-3.5 border-b border-white/5 last:border-0 group cursor-pointer hover:bg-white/5 px-2 -mx-2 rounded-lg transition-colors">
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8">
                    ...
                    <section>
                        ...
                        <div className="space-y-1">
                            <SettingRow icon={Bell} label="Break Reminders" value={true} />
                            <SettingRow icon={Volume2} label="Sound Effects" value={false} />
                            <SettingRow icon={Shield} label="Block Notifications" value={true} />
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="space-y-1">
                            ...
                            <SettingRow icon={Layout} label="Compact Mode" value={false} />
                            <SettingRow icon={Monitor} label="Demo Overlay" value={true} />
                        </div>
                    </section>
                </div>
