...
const ControlsPanel: React.FC<ControlsPanelProps> = ({
  ...
  return (
    <div className="fixed bottom-8 left-1/2 -translate-x-1/2 bg-titanium-surface/80 backdrop-blur-2xl border border-white/10 p-2 sm:p-3 rounded-[2.5rem] shadow-2xl flex items-center gap-2 sm:gap-4 z-50 ring-1 ring-white/5">
